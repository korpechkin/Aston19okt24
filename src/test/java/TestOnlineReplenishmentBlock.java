import org.example.PayConnection;
import org.example.Website;
import org.example.OnlineReplenishmentBlock;
...
public class TestOnlineReplenishmentBlock {
    ...
    public void switchToPayConnection() {
        Assertions.assertInstanceOf(PayConnection.class, onlineReplenishmentBlock.payConnection("297777777", "100"));
        Website.openWebsite(url);
    }
